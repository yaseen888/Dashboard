...
import StatisticsChart from "../StatisticChart/StatisticsChart";
import css from "./Statistics.module.css";
import { BsArrowUpShort } from "react-icons/bs";

const Statistics = () => {
  return (
    <div className={`${css.ontainer}  theme-container`}>{/** theme container is used for transparent black color */}
